...
p_array=("12" "_BLANK+=1" "_SUCCESS+=1" "_SUCCESS+=1" "_SUCCESS+=2" "_SUCCESS+=2" "_ADVANTAGE+=1" "_SUCCESS+=1,_ADVANTAGE+=1" "_SUCCESS+=1,_ADVANTAGE+=1" "_SUCCESS+=1,_ADVANTAGE+=1" "_ADVANTAGE+=2" "_ADVANTAGE+=2" "_TRIUMPH+=1")
c_array=("12" "_BLANK+=1" "_FAILURE+=1" "_FAILURE+=1" "_FAILURE+=2" "_FAILURE+=2" "_THREAT+=1" "_THREAT+=1" "_FAILURE+=1,_THREAT+=1" "_FAILURE+=1,_THREAT+=1" "_THREAT+=2" "_THREAT+=2" "_DESPAIR+=1")
